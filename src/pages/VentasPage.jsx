...
import { Search, ShoppingCart, Calendar, Plus, Wallet, Receipt, X, History, Package } from 'lucide-react'
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {isAdmin && (
            <button
              onClick={() => navigate('/ventas/historial-caja')}
          ...
          {isAdmin && (
            <button
              onClick={() => navigate('/ventas/cierre-caja')}
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5">
        ...
        {showGastoForm && (
          <div className="mt-3 border border-amber-100 bg-amber-50/40 rounded-xl p-4">
            ...
            <div className="flex justify-end gap-2">
              <button
                onClick={() => { setShowGastoForm(false); setNuevoConcepto(''); setNuevoMonto('') }}
        ...
        {gastosHoy.length > 0 && (
          <div className="mt-3 pt-3 border-t border-gray-50 flex justify-between text-sm">
            ...
            <span className="font-bold text-gray-700">S/ {totalGastosHoy.toFixed(2)}</span>
          </div>
        )}
      </div>
