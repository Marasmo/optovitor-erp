...
/**
 * VentaPrint — Ticket de venta interna para impresora térmica de 58mm
 *
 * Uso:
 *   <VentaPrint
 *     sede={{ nombre, direccion, telefono }}
 *     patient={{ nombres, apellidos, dni }}
 *     venta={{ fecha, total, es_pedido_especial }}
 *     items={[{ descripcion, cantidad, precio_unitario, total }]}
 *     pagos={[{ metodo_pago, monto }]}
 *     atendidoPor={{ nombres, apellidos }}
 *   />
 *
...
export default function VentaPrint({
  ...
  // Descuento total = suma de (descuento por unidad * cantidad) de cada línea
    ...
    <div className="ticket-58mm">
      <style>{`
        ...
        @media print {
          ...
          /* El contenedor padre (en VentaDetailPage) usa
             height:0; overflow:hidden para ocultar el ticket en pantalla.
             Al imprimir, debemos revertir eso o el ticket no se verá. */
          .ticket-58mm {
            position: absolute;
            left: 0;
            top: 0;
      ...
      {/* Items — se muestra el TOTAL BASE (precio de catálogo × cantidad,
          SIN descuento). El descuento total se resta aparte más abajo. */}
