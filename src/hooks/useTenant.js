...
const TENANTS = {
  ...
  losandes: {
    id: 'losandes',
    sedeId: '02e5ef01-3f54-470d-90b4-1d2a4d092cd0',
    supabaseUrl: import.meta.env.VITE_SUPABASE_URL_JULIACA,
    supabaseKey: import.meta.env.VITE_SUPABASE_ANON_KEY_JULIACA,
    nombre: 'Óptica Los Andes',
    colores: {
      primary:        '#F97316',
      primaryHover:   '#EA6C0A',
      primaryLight:   '#FFF7ED',
  ...
  azangaro: {
    id: 'azangaro',
    sedeId: 'ab22f9f6-c90b-4a09-960a-5588deb8e7ee',
    supabaseUrl: import.meta.env.VITE_SUPABASE_URL_JULIACA,
    supabaseKey: import.meta.env.VITE_SUPABASE_ANON_KEY_JULIACA,
    nombre: 'Óptica Azángaro',
    colores: {
      primary:        '#095D34',
      primaryHover:   '#064125',
      primaryLight:   '#EEF7F2',
  ...
  sanjoseazangaro: {
    id: 'sanjoseazangaro',
    sedeId: '456df43a-3cc3-4314-958c-50e01326d216',
    supabaseUrl: import.meta.env.VITE_SUPABASE_URL_JULIACA,
    supabaseKey: import.meta.env.VITE_SUPABASE_ANON_KEY_JULIACA,
    nombre: 'Óptica San José Azángaro',
    colores: {
      primary:        '#7C3AED',
      primaryHover:   '#6b2fd1',
      primaryLight:   '#F5F3FF',
...
const HOSTNAME_MAP = {
  ...
  'opticalosandes.netlify.app': 'losandes',
  'demooptovitor.netlify.app': 'demo',
  'demo.optovitor.pe': 'demo',
  'opticaazangaro.netlify.app': 'azangaro',
  'opticasanjoseazangaro.netlify.app': 'sanjoseazangaro',
}
